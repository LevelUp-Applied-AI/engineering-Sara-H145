...
[('2024A', 5, 81.8),I can know that the better group was in the first cohort, after that the score be less by 2.3, but the thired one is the lowest of them by a difference 6.3 than first and 4 with the second]
...
[there are 8 students their score is 80 or above, most of them are in Jordan ]
...
[I noticed about (Lina Barakat), '2024B', she had a 98.0 scored in the first project ('Laptop Verify' , in the second and third 95.0 , 96.0, in sequence, that make me think that this girl is smart and she knows what she did)  ]
